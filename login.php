<?php 
	...
	<div class="header">
		<table>
			<tr>
				<td width="65%">
					<blockquote><h1>Fan</h1></blockquote>
				</td>
				<td>
					<form action="" method="post" accept-charset="UTF-8-BOM">
						...
						<table cellspacing="0" cellpadding="3" role="presentation">
								...
								<tr>
									<td><input type="text" class="inputtext" id="email" name="email" rows="12" ></td>
									<td><input type="password" class="inputtext" id="pass" name="password"></td>
									<td rowspan="2"><button type="submit" name="login">Login</button></td>
								</tr>
						</table>
					</form>
				</td>
	...
	<div class="signup">
		<table>
			<tbody>
				<tr>
					<td width="60%"><span><img src="icons/fan.jpg" /></span></td>
					<td>
						<div class="signupform">
								...
								<?php if (isset($created) && $created){ ?>
									<p>your account is succefully created, you can login now</p>
									<?php $created = false; ?>
								<?php }else{?>					
									<p>Creat a new acount </p>
								<?php }?>
							<form  name="newacount" method="post" action="" accept-charset="UTF-8-BOM">
									<input type="hidden" name="action" value="signup" />
									<input class="signuptext" data-type="text" name="lastname" aria-required="1" placeholder="Lastname" type="text">
									<input class="signuptext" data-type="text" name="firstname" aria-required="1" placeholder="Firstname" type="text">
									<input class="signuptext" data-type="text" name="username" aria-required="1" placeholder="Username" type="text">
									<input class="signuptext" data-type="text" name="reg_email__" aria-required="1" placeholder="Email" type="text">
									<input class="signuptext" data-type="text" name="reg_passwd__" aria-required="1" placeholder="Pass" aria-invalid="true" 
									type="password">
									<div class="signuptext">Birthday</div>
									<div class="_5k_5"><span class="_5k_4" data-type="selectors" data-name="birthday_wrapper" id="u_0_j">
										<span>
										<select aria-label="Day" name="birthday_day" id="day" title="Day" class="_5dba">
											<option value="0" selected="1">Day</option><option value="1">1</option>
										...
										<select aria-label="Month" name="birthday_month" id="month" title="Month" class="_5dba">
											...
											<option value="1">January</option><option value="2">Fabrary</option><option value="3">March</option>
											<option value="4">April</option><option value="5">May</option><option value="6">June</option>
											<option value="7">July</option><option value="8">August</option><option value="9">Septemper</option>
											<option value="10">October</option><option value="11">November</option><option value="12">December</option>
										</select>
										<select aria-label="Year" name="birthday_year" id="year" title="Year" class="_5dba">
											<option value="0" selected="1">Year</option><option value="2017">2017</option>
								...
								<span class="signuptext">
									<input name="sex" value="1" id="u_0_k" type="radio" checked="checked">
									<label class="_58mt" for="u_0_k">Famale</label>
								</span>
								<span class="signuptext">
									<input name="sex" value="2" id="u_0_l" type="radio">
									<label class="_58mt" for="u_0_l">Male</label>
								</span>
								</div>
							<div class="signuptext"><button type="submit">Signup</button></div>
							</form>	
						</div>
					</td>
				</tr>
